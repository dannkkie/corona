  ...
  return (
    <Layout pageName="home">
      ...
      <Container type="content" className="text-center home-start">
        <h2>Simple World Mapping App on latest Corona Virus Cases</h2>
        <ul>
          <li>
            Uses{" "}
            ...
            via{" "}
            <a href="https://coronavirus-tracker-api.herokuapp.com/">
          ...
          <li>
            ...
            - Worldwide Data repository operated by the Johns Hopkins University
          ...
          <li>
            ...
            - U.S. County data that comes from the Conference of State Bank
            Supervisors.
          </li>
        </ul>
      </Container>
